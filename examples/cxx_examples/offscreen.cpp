...
int main(void)
{
    ...
    glfw::InitHint(GLFW_COCOA_MENUBAR, GLFW_FALSE);
...
#if USE_NATIVE_OSMESA
    glfw::GetOSMesaColorBuffer(window, &width, &height, NULL, (void**) &buffer);
#else
    buffer = reinterpret_cast<char*>(calloc(4, width * height));
