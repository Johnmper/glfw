...
int main(int argc, char** argv)
{
...

    {
        ...
        orig_ramp.red = reinterpret_cast<unsigned short *>(malloc(array_size));
        orig_ramp.green = reinterpret_cast<unsigned short *>(malloc(array_size));
        orig_ramp.blue = reinterpret_cast<unsigned short *>(malloc(array_size));
