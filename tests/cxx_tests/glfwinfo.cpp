...
static void list_vulkan_instance_extensions(void)
{
    ...
    ep = reinterpret_cast<VkExtensionProperties *>(calloc(ep_count, sizeof(VkExtensionProperties)));
...
static void list_vulkan_instance_layers(void)
{
    ...
    lp = reinterpret_cast<VkLayerProperties *>(calloc(lp_count, sizeof(VkLayerProperties)));
...
int main(int argc, char** argv)
{
    ...
    if (glfwVulkanSupported())
    {
        ...
        pd = reinterpret_cast<VkPhysicalDevice*>(calloc(pd_count, sizeof(VkPhysicalDevice)));
